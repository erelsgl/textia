...
function show_create_page() {
	...
	set_coalesce($GLOBALS['db_name'], coalesce($GLOBALS['db_name'],'textia'));
	set_coalesce($GLOBALS['db_user'], coalesce($GLOBALS['db_user'],'textia'));
	set_coalesce($GLOBALS['db_pass'], coalesce($GLOBALS['db_pass'],'textia'));
